...
Dataset Glass5 (rasio 1:22,78, sembilan fitur) menunjukkan pola ketiga. Recall naik dari 0,5000 menjadi 1,0000 pada kedua metode, yang berarti seluruh sampel minoritas terdeteksi. Precision turun dari 1,0000 (baseline) menjadi 0,5000 (HOUM-SLS) dan 0,6667 (HOUM-ADASYN). G-Mean meningkat dari 0,7071 menjadi 0,9753 (HOUM-SLS) dan 0,9877 (HOUM-ADASYN). ROC-AUC yang sudah tinggi pada baseline (0,9878) tetap bertahan atau meningkat ke 1,0000 (HOUM-ADASYN). Peningkatan Recall yang besar terjadi karena penyeimbangan data memberikan cukup sampel minoritas kepada model untuk dipelajari, yang sebelumnya hanya tersedia 9 sampel. Penurunan Precision terjadi karena bertambahnya jumlah prediksi positif seiring dengan peningkatan Recall, sehingga beberapa false positive muncul. Meskipun demikian, peningkatan G-Mean dari 0,7071 menjadi 0,9877 menunjukkan bahwa penyeimbangan data berhasil menghasilkan performa klasifikasi yang lebih seimbang antara kelas mayoritas dan minoritas. Peningkatan ini didukung oleh peningkatan Recall hingga 1,0000 yang menunjukkan seluruh sampel minoritas berhasil terdeteksi. Kondisi ini berkontribusi pada peningkatan ROC-AUC, karena model mampu membedakan kedua kelas dengan lebih baik setelah ADASYN menghasilkan sampel sintetis pada area yang sulit dipelajari dan HOUM menghilangkan sampel mayoritas yang kurang informatif. Sembilan fitur pada Glass5 juga memberikan ruang pemisahan yang baik sehingga data sintetis tidak menciptakan tumpang tindih berarti, berbeda dengan Haberman yang memiliki ruang fitur terbatas. \par
