...
\begin{document}
    ...
    \title{Pengaruh Variasi Oversampling dan Konfigurasi SVM Pada Metode HOUM Terhadap Data Klasifikasi Tidak Seimbang}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{The Effect of Oversampling Variations and SVM Configurations in the HOUM Method on Imbalanced Classification Data}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
	\author{Rizki Alfariz Ramadhan}		% Nama Mahasiswa
	\nim{122140061}				% NIM Mahasiswa
	...
	\pengujiA%
		...
		{NIP. 19930109 201903 1 017}	% NIP Dosen Penguji 1
	\pengujiB%
